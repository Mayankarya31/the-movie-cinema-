...
// var myAPI = '984f679413615dc0c6e3749071d20de2'  // global string to be consistent with future usages elsewhere
// $(function() {
...
//   }
// Replace 'YOUR_API_KEY' below with your API key retrieved from https://www.themoviedb.org
var myAPI = 'eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI5ODRmNjc5NDEzNjE1ZGMwYzZlMzc0OTA3MWQyMGRlMiIsIm5iZiI6MTc3MDM5MDA4OC4yOTUsInN1YiI6IjY5ODYwMjQ4MmVkNzEzNzViNjIxOTE2ZSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.tiI7NoOZz-3JLB6fjIIyU_-FuyOG0NYkAlP6lhVhPZ0'  // global string to be consistent with future usages elsewhere
$(function() {
  $('#movie_list').css('display','none');
  $('#autoComplete').blur(function() {
    $('#movie_list').css('display','none');
...
function get_individual_cast(movie_cast,my_api_key) {
    ...
    for(var cast_id in movie_cast.cast_ids){
      $.ajax({
        type:'GET',
        url:'https://api.themoviedb.org/3/person/'+movie_cast.cast_ids[cast_id],
        async:false,
        headers: {
          'Authorization': 'Bearer ' + my_api_key,
          'Content-Type': 'application/json;charset=utf-8'
